...
<script type="text/javascript">
	function show(cid,jobName,jobAddress,releaseTime,jobSalary,companyName) {
		var url = "${pageContext.request.contextPath} /com/showOneCompany?cid=" + cid
				+"&jobName="+jobName
					...
					<c:forEach items="${jobInfoList}" var="jobInfo">
						<tr class="table table-hover">
							...
							<td><a href="javascript:void(0)"
								onclick="show('${jobInfo.company.cid}',
											  '${jobInfo.jobName}',
										      '${jobInfo.jobAddress}',
											  '${jobInfo.releaseTime}',
											  '${jobInfo.jobSalary}',
											  '${jobInfo.company.companyName}')" class="btn btn-default">查看公司详情</a></td>
						</tr>
					</c:forEach>
				</table>
		</div>
